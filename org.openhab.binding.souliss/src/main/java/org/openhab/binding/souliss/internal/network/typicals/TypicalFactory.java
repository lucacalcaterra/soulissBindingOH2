...
public class TypicalFactory {
    ...
    public static SoulissGenericTypical getClass(short soulissType, DatagramSocket _datagramsocket,
        ...
        switch (soulissType) {
            ...
            // break;
            // case SoulissBindingProtocolConstants.Souliss_T1n_RGB:
            // break;
            ...
            // break;
            // case SoulissBindingProtocolConstants.Souliss_T58_PressureSensor:
            // T = new SoulissT58(sSoulissNodeIPAddressOnLAN, iIDNodo, iSlot, sOHType);
            // break;
            // case SoulissBindingProtocolConstants.Souliss_TService_NODE_HEALTY:
            // T = new SoulissTServiceNODE_HEALTY(sSoulissNodeIPAddressOnLAN, iIDNodo, iSlot, sOHType);
            // break;
            // case SoulissBindingProtocolConstants.Souliss_TService_NODE_TIMESTAMP:
