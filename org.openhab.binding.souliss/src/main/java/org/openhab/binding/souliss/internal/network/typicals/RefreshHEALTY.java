...
public class RefreshHEALTY {
    ...
    public RefreshHEALTY(DatagramSocket datagramsocket, String soulissNodeIPAddressOnLAN) {
    ...
    public void tick() {
        ...
        SoulissCommonCommands.sendHEALTY_REQUESTframe(socket, soulissNodeIPAddressOnLAN,
