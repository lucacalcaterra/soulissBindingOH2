...
public class RefreshSUBSCRIPTION {
    ...
    int iNodes = 0;
    private static Logger logger = LoggerFactory.getLogger(RefreshSUBSCRIPTION.class);

    public RefreshSUBSCRIPTION(DatagramSocket datagramsocket, String soulissNodeIPAddressOnLAN) {
    ...
    public void tick() {
        ...
        SoulissCommonCommands.sendSUBSCRIPTIONframe(socket, soulissNodeIPAddressOnLAN,
