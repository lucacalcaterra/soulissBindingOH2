 ...
 *
 * <ul>
 * <li>The channel number the bulb has on the souliss bridge where 0 represents all white bulbs, 1-4 white channels an 5
 * RGB bulbs.</li>
...
public class SoulissThingState {
    ...
    private final SoulissCommunication com;
    ...
    public SoulissThingState(int bulb, SoulissCommunication com) {
        this.bulb = bulb;
        this.com = com;
    }
