...
public class StateTraslator {
    ...
    public static Short commandsOHtoSOULISS(int typ, String sCommand) {
        String sRes = null;
        sRes = propCommands.getProperty("0x" + Short.decode(Integer.toHexString(typ))
                + SoulissBindingProtocolConstants.CONF_FIELD_DELIMITER + sCommand);
    ...
    public static String statesSoulissToOH(String sOHType, short s, short f) {
        ...
        String sRes = null;
        String sVal = sOHType + SoulissBindingProtocolConstants.CONF_FIELD_DELIMITER + s1
                + SoulissBindingProtocolConstants.CONF_FIELD_DELIMITER + s2;
    ...
    public static String translateCommandsToExpectedStates(short soulissType, short s) {
        ...
        String sRes = null;
        String sVal = s1.trim() + SoulissBindingProtocolConstants.CONF_FIELD_DELIMITER + s2.trim();
