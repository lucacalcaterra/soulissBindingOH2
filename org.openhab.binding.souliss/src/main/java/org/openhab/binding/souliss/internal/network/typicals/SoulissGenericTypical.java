...
public abstract class SoulissGenericTypical {
    ...
    void commandMulticast(DatagramSocket datagramSocket, short command) {
        ...
        SoulissCommonCommands.sendMULTICASTFORCEFrame(datagramSocket, SoulissBindingNetworkParameters.IPAddressOnLAN,
                getType(), command);
    }
    ...
    public void sendDBStructFrame(DatagramSocket datagramSocket) {
        ...
        SoulissCommonCommands.sendDBStructFrame(datagramSocket, SoulissBindingNetworkParameters.IPAddressOnLAN);
    }
    ...
    public void ping(DatagramSocket datagramSocket, short putIn_1, short punIn_2) {
        ...
        SoulissCommonCommands.sendPing(datagramSocket, SoulissBindingNetworkParameters.IPAddressOnLAN, putIn_1,
                punIn_2);
    }
