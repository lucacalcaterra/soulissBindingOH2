...
public class ThingDiscoveryService extends AbstractDiscoveryService {
    ...
    private SoulissGatewayHandler handler;

    public ThingDiscoveryService(ThingUID bridgeUID, SoulissGatewayHandler handler) {
        super(SoulissBindingConstants.SUPPORTED_THING_TYPES_UIDS, 2, true);
        // super(SoulissBindingConstants.GATEWAY_THING_TYPE, 2, true);
